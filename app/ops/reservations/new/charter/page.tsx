...
export default async function NewCharterReservationPage() {
  ...
  return (
    <section className="space-y-6">
      <Card title="Charter Reservation" subtitle="Create a charter reservation.">
        <CharterReservationForm flights={(data ?? []) as FlightRow[]} />
      </Card>
    </section>
  );
}